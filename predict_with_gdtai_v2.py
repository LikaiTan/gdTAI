...
DEFAULT_V2_MODEL = Path("Integrated_dataset/models/gdT_prediction_classifier/gdTAI_v2.0/gdTAI_v2_model.pkl")
STATIC_ROOT = Path("gdT_prediction/external_tests")
TABLE_ROOT = Path("Integrated_dataset/tables/gdT_prediction/external_tests")
FIGURE_ROOT = Path("Integrated_dataset/figures/gdT_prediction/external_tests")
LOG_ROOT = Path("Integrated_dataset/logs/gdT_prediction/external_tests")
