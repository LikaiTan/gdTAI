...
# Config
INPUT_H5AD = _TNK_PROJECT_ROOT / "Integrated_dataset/TNK_cleaned.h5ad"
OUTPUT_H5AD = _TNK_PROJECT_ROOT / "Integrated_dataset/integrated.h5ad"
...
NFS_LINK_ROOT = _TNK_PROJECT_ROOT / "high_speed_temp"
NFS_LINK_OUTPUT_ROOT = NFS_LINK_ROOT / OUTPUT_ROOT.name
LOCAL_FINAL_OUTPUT_H5AD = LOCAL_OUTPUT_ROOT / OUTPUT_H5AD.name

MAIN_METADATA_CSV = _TNK_PROJECT_ROOT / "analysis_26GSE_V4/outputs/harmonized_metadata_v4.csv"
SUPP_METADATA_CSV = _TNK_PROJECT_ROOT / "analysis_26GSE_V4/outputs/harmonized_metadata_supp.csv"
